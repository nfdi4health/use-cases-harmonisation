...
dpe_tracy <- readxl::read_excel(here::here(paste0("Tracy/DPE_", studyname, "_TRACY.xlsx")), sheet = 1)
dpe_ines <- readxl::read_excel(here::here(paste0("Ines/DPE_", studyname, "_INES.xlsx")), sheet = 1)
dpe_franzi <- readxl::read_excel(here::here(paste0("Franzi/DPE_", studyname, "_FRANZI.xlsx")), sheet = 1)
...
### 2.1.1 Tracy ----
dd_tracy <-list(Variables = tibble::tibble(readxl::read_excel(here::here("Tracy/", paste0("DD_",studyname, "_TRACY.xlsx")), sheet = 1)),
     Categories = tibble::tibble(readxl::read_excel(here::here("Tracy/", paste0("DD_",studyname, "_TRACY.xlsx")), sheet = 2)))
...
### 2.1.2 Ines ----
dd_ines <-list(Variables = tibble::tibble(readxl::read_excel(here::here("Ines/", paste0("DD_",studyname, "_INES.xlsx")), sheet = 1)),
                Categories = tibble::tibble(readxl::read_excel(here::here("Ines/", paste0("DD_",studyname, "_INES.xlsx")), sheet = 2)))
...
### 2.1.3 Franzi ----
dd_franzi <-list(Variables = tibble::tibble(readxl::read_excel(here::here("Franzi/", paste0("DD_",studyname, "_FRANZI.xlsx")), sheet = 1)),
                Categories = tibble::tibble(readxl::read_excel(here::here("Franzi/", paste0("DD_",studyname, "_FRANZI.xlsx")), sheet = 2)))
